...
```javascript
var SecureApi = require('secure_api');


var api = new SecureApi.SecureAutopayEnrollmentApi()
var xApiKey = "xApiKey_example"; // {String} an authorization header
var xAppKey = "xAppKey_example"; // {String} an authorization header
var xVersion = 3.4; // {Number} x-version
var origin = "origin_example"; // {String} origin
var autoPayEnrollmentRequest = new SecureApi.AutoPayEnrollmentRequest(); // {AutoPayEnrollmentRequest} Autopay Enrollment Detail
...
api.secureAutopayenrollmentPost(xApiKey, xAppKey, xVersion, origin, autoPayEnrollmentRequest, callback);
...
------------ | ------------- | ------------- | -------------
*SecureApi.SecureAutopayEnrollmentApi* | [**secureAutopayenrollmentPost**](docs/SecureAutopayEnrollmentApi.md#secureAutopayenrollmentPost) | **POST** /secure/autopayenrollment | This API is used for Autopay Enrollment.
...
*SecureApi.SecureOutboundPaymentsApi* | [**vendorapiSecureOutboundpaymentsImagePost**](docs/SecureOutboundPaymentsApi.md#vendorapiSecureOutboundpaymentsImagePost) | **POST** /vendorapi/secure/outboundpayments/image | This API gets outbound payment JPG image in Base64 string format
...
## Documentation for Models
 ...
 - [SecureApi.AutoPayEnrollmentRequest](docs/AutoPayEnrollmentRequest.md)
 - [SecureApi.AutoPayEnrollmentResponse](docs/AutoPayEnrollmentResponse.md)
 ...
 - [SecureApi.OutboundPaymentImageResponseDTO](docs/OutboundPaymentImageResponseDTO.md)
 ...
 - [SecureApi.PFLiteSecureQuoteRequestAgent](docs/PFLiteSecureQuoteRequestAgent.md)
 - [SecureApi.PFLiteSecureQuoteRequestAgentAddress](docs/PFLiteSecureQuoteRequestAgentAddress.md)
 ...
 - [SecureApi.PaymentIntentResponseIntent](docs/PaymentIntentResponseIntent.md)
 ...
 - [SecureApi.PaymentLinkRequestReferenceDataListInner](docs/PaymentLinkRequestReferenceDataListInner.md)
 ...
 - [SecureApi.SecurePFQuoteBookingRequest](docs/SecurePFQuoteBookingRequest.md)
