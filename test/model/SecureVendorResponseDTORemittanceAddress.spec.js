...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SecureApi.SecureVendorResponseDTORemittanceAddress();
  });
  ...
  describe('SecureVendorResponseDTORemittanceAddress', function() {
    it('should create an instance of SecureVendorResponseDTORemittanceAddress', function() {
      // uncomment below and update the code to test SecureVendorResponseDTORemittanceAddress
      //var instance = new SecureApi.SecureVendorResponseDTORemittanceAddress();
      //expect(instance).to.be.a(SecureApi.SecureVendorResponseDTORemittanceAddress);
    });
