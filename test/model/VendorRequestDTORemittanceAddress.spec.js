...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SecureApi.VendorRequestDTORemittanceAddress();
  });
  ...
  describe('VendorRequestDTORemittanceAddress', function() {
    it('should create an instance of VendorRequestDTORemittanceAddress', function() {
      // uncomment below and update the code to test VendorRequestDTORemittanceAddress
      //var instance = new SecureApi.VendorRequestDTORemittanceAddress();
      //expect(instance).to.be.a(SecureApi.VendorRequestDTORemittanceAddress);
    });
