...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SecureApi.VendorRequestDTOPhysicalAddress();
  });
  ...
  describe('VendorRequestDTOPhysicalAddress', function() {
    it('should create an instance of VendorRequestDTOPhysicalAddress', function() {
      // uncomment below and update the code to test VendorRequestDTOPhysicalAddress
      //var instance = new SecureApi.VendorRequestDTOPhysicalAddress();
      //expect(instance).to.be.a(SecureApi.VendorRequestDTOPhysicalAddress);
    });
