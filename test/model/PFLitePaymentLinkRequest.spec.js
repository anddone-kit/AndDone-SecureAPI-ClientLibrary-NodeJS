...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SecureApi.PFLitePaymentLinkRequest();
  });
  ...
  describe('PFLitePaymentLinkRequest', function() {
    it('should create an instance of PFLitePaymentLinkRequest', function() {
      // uncomment below and update the code to test PFLitePaymentLinkRequest
      //var instance = new SecureApi.PFLitePaymentLinkRequest();
      //expect(instance).to.be.a(SecureApi.PFLitePaymentLinkRequest);
    });
