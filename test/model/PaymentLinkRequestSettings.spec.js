...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SecureApi.PaymentLinkRequestSettings();
  });
  ...
  describe('PaymentLinkRequestSettings', function() {
    it('should create an instance of PaymentLinkRequestSettings', function() {
      // uncomment below and update the code to test PaymentLinkRequestSettings
      //var instance = new SecureApi.PaymentLinkRequestSettings();
      //expect(instance).to.be.a(SecureApi.PaymentLinkRequestSettings);
    });
