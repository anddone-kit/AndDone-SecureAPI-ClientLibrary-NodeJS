...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SecureApi.TransactionPaymentResponseTransactionResult();
  });
  ...
  describe('TransactionPaymentResponseTransactionResult', function() {
    it('should create an instance of TransactionPaymentResponseTransactionResult', function() {
      // uncomment below and update the code to test TransactionPaymentResponseTransactionResult
      //var instance = new SecureApi.TransactionPaymentResponseTransactionResult();
      //expect(instance).to.be.a(SecureApi.TransactionPaymentResponseTransactionResult);
    });
