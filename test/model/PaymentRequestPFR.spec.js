...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SecureApi.PaymentRequestPFR();
  });
  ...
  describe('PaymentRequestPFR', function() {
    it('should create an instance of PaymentRequestPFR', function() {
      // uncomment below and update the code to test PaymentRequestPFR
      //var instance = new SecureApi.PaymentRequestPFR();
      //expect(instance).to.be.a(SecureApi.PaymentRequestPFR);
    });
