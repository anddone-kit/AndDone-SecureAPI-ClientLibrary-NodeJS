...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SecureApi.PFLitePaymentLinkRequestCallbackParameters();
  });
  ...
  describe('PFLitePaymentLinkRequestCallbackParameters', function() {
    it('should create an instance of PFLitePaymentLinkRequestCallbackParameters', function() {
      // uncomment below and update the code to test PFLitePaymentLinkRequestCallbackParameters
      //var instance = new SecureApi.PFLitePaymentLinkRequestCallbackParameters();
      //expect(instance).to.be.a(SecureApi.PFLitePaymentLinkRequestCallbackParameters);
    });
