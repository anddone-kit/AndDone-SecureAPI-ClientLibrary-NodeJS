...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SecureApi.PFLitePaymentLinkRequestSettings();
  });
  ...
  describe('PFLitePaymentLinkRequestSettings', function() {
    it('should create an instance of PFLitePaymentLinkRequestSettings', function() {
      // uncomment below and update the code to test PFLitePaymentLinkRequestSettings
      //var instance = new SecureApi.PFLitePaymentLinkRequestSettings();
      //expect(instance).to.be.a(SecureApi.PFLitePaymentLinkRequestSettings);
    });
