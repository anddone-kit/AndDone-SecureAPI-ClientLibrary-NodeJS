...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SecureApi.SecurePaymentDetailsResponse();
  });
  ...
  describe('SecurePaymentDetailsResponse', function() {
    it('should create an instance of SecurePaymentDetailsResponse', function() {
      // uncomment below and update the code to test SecurePaymentDetailsResponse
      //var instance = new SecureApi.SecurePaymentDetailsResponse();
      //expect(instance).to.be.a(SecureApi.SecurePaymentDetailsResponse);
    });
