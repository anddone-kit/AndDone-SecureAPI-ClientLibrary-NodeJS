...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SecureApi.TransactionDetailResponseTenderInfo();
  });
  ...
  describe('TransactionDetailResponseTenderInfo', function() {
    it('should create an instance of TransactionDetailResponseTenderInfo', function() {
      // uncomment below and update the code to test TransactionDetailResponseTenderInfo
      //var instance = new SecureApi.TransactionDetailResponseTenderInfo();
      //expect(instance).to.be.a(SecureApi.TransactionDetailResponseTenderInfo);
    });
