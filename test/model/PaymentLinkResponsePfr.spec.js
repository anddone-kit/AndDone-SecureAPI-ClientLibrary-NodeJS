...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SecureApi.PaymentLinkResponsePfr();
  });
  ...
  describe('PaymentLinkResponsePfr', function() {
    it('should create an instance of PaymentLinkResponsePfr', function() {
      // uncomment below and update the code to test PaymentLinkResponsePfr
      //var instance = new SecureApi.PaymentLinkResponsePfr();
      //expect(instance).to.be.a(SecureApi.PaymentLinkResponsePfr);
    });
