...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SecureApi.PaymentLinkResponseDisplaySettings();
  });
  ...
  describe('PaymentLinkResponseDisplaySettings', function() {
    it('should create an instance of PaymentLinkResponseDisplaySettings', function() {
      // uncomment below and update the code to test PaymentLinkResponseDisplaySettings
      //var instance = new SecureApi.PaymentLinkResponseDisplaySettings();
      //expect(instance).to.be.a(SecureApi.PaymentLinkResponseDisplaySettings);
    });
