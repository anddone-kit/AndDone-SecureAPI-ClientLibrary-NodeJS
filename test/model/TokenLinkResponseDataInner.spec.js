...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SecureApi.TokenLinkResponseDataInner();
  });
  ...
  describe('TokenLinkResponseDataInner', function() {
    it('should create an instance of TokenLinkResponseDataInner', function() {
      // uncomment below and update the code to test TokenLinkResponseDataInner
      //var instance = new SecureApi.TokenLinkResponseDataInner();
      //expect(instance).to.be.a(SecureApi.TokenLinkResponseDataInner);
    });
