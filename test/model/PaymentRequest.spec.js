...
(function(root, factory) {
  ...
  describe('PaymentRequest', function() {
    ...
    it('should have the property customerIndentityRequest (base name: "customerIndentityRequest")', function() {
      // uncomment below and update the code to test the property customerIndentityRequest
      //var instance = new SecureApi.PaymentRequest();
      //expect(instance).to.be();
    });
