...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SecureApi.PaymentListResponseDTO();
  });
  ...
  describe('PaymentListResponseDTO', function() {
    it('should create an instance of PaymentListResponseDTO', function() {
      // uncomment below and update the code to test PaymentListResponseDTO
      //var instance = new SecureApi.PaymentListResponseDTO();
      //expect(instance).to.be.a(SecureApi.PaymentListResponseDTO);
    });
