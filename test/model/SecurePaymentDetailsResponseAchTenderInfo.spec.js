...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SecureApi.SecurePaymentDetailsResponseAchTenderInfo();
  });
  ...
  describe('SecurePaymentDetailsResponseAchTenderInfo', function() {
    it('should create an instance of SecurePaymentDetailsResponseAchTenderInfo', function() {
      // uncomment below and update the code to test SecurePaymentDetailsResponseAchTenderInfo
      //var instance = new SecureApi.SecurePaymentDetailsResponseAchTenderInfo();
      //expect(instance).to.be.a(SecureApi.SecurePaymentDetailsResponseAchTenderInfo);
    });
