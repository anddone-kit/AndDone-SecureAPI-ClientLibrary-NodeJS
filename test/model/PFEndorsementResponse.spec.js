...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SecureApi.PFEndorsementResponse();
  });
  ...
  describe('PFEndorsementResponse', function() {
    it('should create an instance of PFEndorsementResponse', function() {
      // uncomment below and update the code to test PFEndorsementResponse
      //var instance = new SecureApi.PFEndorsementResponse();
      //expect(instance).to.be.a(SecureApi.PFEndorsementResponse);
    });
