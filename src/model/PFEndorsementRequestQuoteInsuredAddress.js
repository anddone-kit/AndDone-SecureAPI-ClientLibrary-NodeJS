...
/**
 * The PFEndorsementRequestQuoteInsuredAddress model module.
 * @module model/PFEndorsementRequestQuoteInsuredAddress
 * @version 2.3
 */
class PFEndorsementRequestQuoteInsuredAddress {
    /**
     * Constructs a new <code>PFEndorsementRequestQuoteInsuredAddress</code>.
     * This denotes the address of the insured.
     * @alias module:model/PFEndorsementRequestQuoteInsuredAddress
     */
    constructor() { 
        
        PFEndorsementRequestQuoteInsuredAddress.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PFEndorsementRequestQuoteInsuredAddress</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PFEndorsementRequestQuoteInsuredAddress} obj Optional instance to populate.
     * @return {module:model/PFEndorsementRequestQuoteInsuredAddress} The populated <code>PFEndorsementRequestQuoteInsuredAddress</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>PFEndorsementRequestQuoteInsuredAddress</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PFEndorsementRequestQuoteInsuredAddress</code>.
     */
...
export default PFEndorsementRequestQuoteInsuredAddress;
